...
3. **Legacy Code Reference Approach**
   - For each acceptance criterion in the document:
     a. Examine the legacy codebase at `C:/Users/james/Master/BrightHub/BRun/v4-show/src`
...
- **Functional Requirements:** `C:/Users/james/Master/BrightHub/BRun/v4-show/pmc/product/03-train-functional-requirements.md`
  - Contains all the requirements and acceptance criteria that need references.
- **Legacy Codebase:** `C:/Users/james/Master/BrightHub/BRun/v4-show/src`
