...
One more reminder. Your job is ONLY to update system\plans\new-tests\02-new-test-carry-context-06-22-25-0217PM.md with an in depth context build of all of the information it will need to fully create a customized test plan. Remove any sections not used.

**Completion Check**: Verify that `system\plans\new-tests\02-new-test-carry-context-06-22-25-0217PM.md` has been updated with and contains all required sections before proceeding to Step 2.
...
- `system\plans\new-tests\02-new-test-carry-context-06-22-25-0217PM.md` (context from Step 1)
