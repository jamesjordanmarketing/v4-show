...
- 📄 Path to the new task file: system\plans\new-tests\01-new-test-carry-prompt-06-22-25-0422PM.md
- 📄 Path to the new conductor file: system\plans\new-tests\04-new-test-conductor-prompt-06-22-25-0422PM.md
...
system\plans\new-tests\02-new-test-carry-context-06-22-25-0422PM.md and system\plans\new-tests\03-new-test-active-test-2-enhanced-06-22-25-0422PM.md
...
Execute the test conductor prompt in system\plans\new-tests\04-new-test-conductor-prompt-06-22-25-0422PM.md to customize the new test conductor prompt. 
