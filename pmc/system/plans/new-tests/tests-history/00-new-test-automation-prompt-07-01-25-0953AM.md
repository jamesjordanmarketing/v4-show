...
- 📄 Path to the new task file: system\plans\new-tests\01-new-test-carry-prompt-07-01-25-0953AM.md
- 📄 Path to the new conductor file: system\plans\new-tests\04-new-test-conductor-prompt-07-01-25-0953AM.md
...
system\plans\new-tests\02-new-test-carry-context-07-01-25-0953AM.md and system\plans\new-tests\03-new-test-active-test-2-enhanced-07-01-25-0953AM.md
...
Execute the test conductor prompt in system\plans\new-tests\04-new-test-conductor-prompt-07-01-25-0953AM.md to customize the new test conductor prompt. 
Wait for 20 seconds to make sure the prompt has finished executing. 

Check that the output in system\plans\new-tests\05-new-test-conductor-output-07-01-25-0953AM.md  
...
## Next Steps
The human will copy the system\plans\new-tests\05-new-test-conductor-output-07-01-25-0953AM.md prompt into the next ai testing agent panel.
