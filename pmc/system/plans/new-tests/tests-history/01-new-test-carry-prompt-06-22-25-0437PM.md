...
This carryover is going to be focused ONLY on the work you did by executing the Task T-2.2.5 in pmc\core\active-task.md
...
system\plans\new-tests\02-new-test-carry-context-06-22-25-0437PM.md
...
One more reminder. Your job is ONLY to update system\plans\new-tests\02-new-test-carry-context-06-22-25-0437PM.md with an in depth context build of all of the information it will need to fully create a customized test plan. Remove any sections not used.

**Completion Check**: Verify that `system\plans\new-tests\02-new-test-carry-context-06-22-25-0437PM.md` has been updated with and contains all required sections before proceeding to Step 2.
...
- `system\plans\new-tests\02-new-test-carry-context-06-22-25-0437PM.md` (context from Step 1)
- `pmc/core/active-task.md` (implemented task details)

Create an enhanced test plan at: `system\plans\new-tests\03-new-test-active-test-2-enhanced-06-22-25-0437PM.md`
...
**Completion Check**: Verify that `system\plans\new-tests\03-new-test-active-test-2-enhanced-06-22-25-0437PM.md` exists, is task-specific, and uses directive language throughout before proceeding to Step 3.

Once confirmed copy `system\plans\new-tests\03-new-test-active-test-2-enhanced-06-22-25-0437PM.md` into pmc\core\active-task-unit-tests-2-enhanced.md replacing everything already there.
