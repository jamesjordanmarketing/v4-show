...
Parameters
- FR Number: FR1.1.1
- Stage Name: Stage 1 — Database Foundation & Core Schema
...
Title
- FR FR1.1.1 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Title
- FR FR1.1.2 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.2.1 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.2.1 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.2.2 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 350.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.2.2 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.2.3 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 466.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
  - === BEGIN PROMPT FR: FR1.2.3 ===
  - === END PROMPT FR: FR1.2.3 ===
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.2.3 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.2.3 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.3.1 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 582.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.3.1 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.3.2 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 698.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.3.2 Wireframes — Stage 1 — Database Foundation & Core Schema
...
Mandates
- Locate FR FR1.3.3 in pmc/product/_mapping/fr-maps/prompts/04-FR-wireframes-prompt-E01.md at line 814.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-bmo-FR-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
  - === BEGIN PROMPT FR: FR1.3.3 ===
  - === END PROMPT FR: FR1.3.3 ===
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.3.3 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.3.3 Wireframes — Stage 1 — Database Foundation & Core Schema
