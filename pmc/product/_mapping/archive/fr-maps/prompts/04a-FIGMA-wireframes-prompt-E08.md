...
- Task-Specific FR Map: `pmc/product/_mapping/fr-maps/04-pipeline-FR-wireframes-E08.md`
...
- FR Locate File: pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md
- FR Locate Line: 1
- Output File (append): pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md

Mandates
- Locate FR FR8.1.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md at line 1.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md.
...
Final Output Format (append to pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md)

=== BEGIN PROMPT FR: FR8.1.1 ===

Title
- FR FR8.1.1 Wireframes — Stage 8 — Team Collaboration & Notifications
...
Mandates
- Locate FR FR8.1.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md at line 118.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR8.1.2 Wireframes — Stage 8 — Team Collaboration & Notifications
...
Mandates
- Locate FR FR8.2.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR8.2.1 Wireframes — Stage 8 — Team Collaboration & Notifications
...
Mandates
- Locate FR FR8.2.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md at line 350.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR8.2.2 Wireframes — Stage 8 — Team Collaboration & Notifications
...
Mandates
- Locate FR FR8.3.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E08.md at line 466.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E08.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR8.3.1 Wireframes — Stage 8 — Team Collaboration & Notifications
