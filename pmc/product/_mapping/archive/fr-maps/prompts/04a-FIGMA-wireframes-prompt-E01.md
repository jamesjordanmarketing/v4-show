...
- Task-Specific FR Map: `pmc/product/_mapping/fr-maps/04-pipeline-FR-wireframes-E01.md`
- User Journey: `pmc/product/02b-pipeline-user-journey.md`

Parameters
- FR Number: FR1.1.1
- Stage Name: Stage 1 — Training Job Configuration & Setup
- Section ID: E01 (E.g., E01)
- Journey Stage Number: 1 (1-6)
- Minimum Page Count: 3 (default: 3)
- FR Locate File: pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md
- FR Locate Line: 1
- Output File (append): pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md

Mandates
- Locate FR FR1.1.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 1.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
...
Final Output Format (append to pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md)

=== BEGIN PROMPT FR: FR1.1.1 ===

Title
- FR FR1.1.1 Wireframes — Stage 1 — Training Job Configuration & Setup
...
- Progressive Disclosure:
  * Basic: Simple 3-step project creation wizard
  * Advanced: Advanced project settings and customization
  * Expert: API configuration and integration options
- Success Indicators: Clear value proposition understood, Project successfully created, User feels confident to proceed, Trust established with platform
...
Mandates
- Locate FR FR1.1.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 118.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.1.2 Wireframes — Stage 1 — Training Job Configuration & Setup
...
Mandates
- Locate FR FR1.1.3 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR1.1.3 Wireframes — Stage 1 — Training Job Configuration & Setup
...
Mandates
- Locate FR FR1.2.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 350.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.2.1 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.2.1 Wireframes — Stage 1 — Training Job Configuration & Setup
...
Mandates
- Locate FR FR1.2.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 466.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.2.2 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.2.2 Wireframes — Stage 1 — Training Job Configuration & Setup
...
Mandates
- Locate FR FR1.3.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 582.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.3.1 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.3.1 Wireframes — Stage 1 — Training Job Configuration & Setup
...
Mandates
- Locate FR FR1.3.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E01.md at line 698.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E01.md.
- Use the following markers when writing the final output block:
...
0) Extract journey context for Stage 1:
   ...
   - Progressive disclosure requirements
   - Persona-specific UI adaptations
1) Identify FR FR1.3.2 in the Task-Specific FR Map (or the main FR file if not present) and collect all acceptance criteria:
   - User Story Acceptance Criteria mapped to this FR
   - Functional Requirements Acceptance Criteria for this FR
2) Classify each criterion as UI-relevant vs Non-UI.
3) Compute a Page Plan (≥ 3) to satisfy all UI-relevant criteria with clear flows and states.
...
Title
- FR FR1.3.2 Wireframes — Stage 1 — Training Job Configuration & Setup
