...
- Task-Specific FR Map: `pmc/product/_mapping/fr-maps/04-pipeline-FR-wireframes-E03.md`
- User Journey: `pmc/product/02b-pipeline-user-journey.md`

Parameters
- FR Number: FR3.1.1
- Stage Name: Stage 3 — Error Handling & Recovery
- Section ID: E03 (E.g., E01)
- Journey Stage Number: 3 (1-6)
- Minimum Page Count: 3 (default: 3)
- FR Locate File: pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md
- FR Locate Line: 1
- Output File (append): pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md

Mandates
- Locate FR FR3.1.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 1.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
...
Final Output Format (append to pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md)

=== BEGIN PROMPT FR: FR3.1.1 ===

Title
- FR FR3.1.1 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.1.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 118.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.1.2 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.1.3 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.1.3 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.2.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 350.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.2.1 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.2.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 466.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.2.2 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.3.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 582.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.3.1 Wireframes — Stage 3 — Error Handling & Recovery
...
Mandates
- Locate FR FR3.3.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E03.md at line 698.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E03.md.
- Use the following markers when writing the final output block:
...
Title
- FR FR3.3.2 Wireframes — Stage 3 — Error Handling & Recovery
