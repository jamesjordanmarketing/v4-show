...
- Task-Specific FR Map: `pmc/product/_mapping/fr-maps/04-pipeline-FR-wireframes-E04.md`
- User Journey: `pmc/product/02b-pipeline-user-journey.md`

Parameters
- FR Number: FR4.1.1
- Stage Name: Stage 4 — Model Artifacts & Downloads
- Section ID: E04 (E.g., E01)
- Journey Stage Number: 4 (1-6)
- Minimum Page Count: 3 (default: 3)
- FR Locate File: pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md
- FR Locate Line: 1
- Output File (append): pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md

Mandates
- Locate FR FR4.1.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 1.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
...
Final Output Format (append to pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md)
...
Mandates
- Locate FR FR4.1.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 118.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
- Use the following markers when writing the final output block:
...
Mandates
- Locate FR FR4.2.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 234.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
- Use the following markers when writing the final output block:
...
Mandates
- Locate FR FR4.2.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 350.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
- Use the following markers when writing the final output block:
...
Mandates
- Locate FR FR4.3.1 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 466.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
- Use the following markers when writing the final output block:
...
Mandates
- Locate FR FR4.3.2 in pmc/product/_mapping/fr-maps/prompts/04a-FIGMA-wireframes-prompt-E04.md at line 582.
- Append the final Figma-ready prompt for this FR between explicit markers to: pmc/product/_mapping/fr-maps/04-pipeline-FIGMA-wireframes-output-E04.md.
- Use the following markers when writing the final output block:
