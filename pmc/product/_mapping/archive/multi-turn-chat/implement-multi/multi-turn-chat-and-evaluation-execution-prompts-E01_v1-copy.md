...
Execute these SQL statements in the Supabase Dashboard SQL Editor (https://supabase.com/dashboard - SQL Editor):
...
### Task 2: Seed Multi-Turn Evaluator

Insert the multi-turn arc-aware evaluator prompt:
