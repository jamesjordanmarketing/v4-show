...
**Based on:** Wireframes (in folder \4-categories-wf\) and Wireframe Details (FR3.3.2-3.3.4)

**Source References:**
- Seed Story: `pmc\product\00-bmo-seed-story.md`
- Overview Document: `pmc\product\01-bmo-overview.md`

- Wireframe Prompt: `pmc\product\_mapping\fr-maps\04-bmo-FR-wireframes-output-E03-categorization-3.2-3.4_v1.md`
- Wireframe Codebase: `4-categories-wf`
- Unstructured User Stories: `pmc\product\_seeds\seed-narrative-v1.md`
...
- Storing all derived document attributes in the Supabase relational database
