...
- Overview: `pmc/product/01-[PRODUCT_ABBR_PLACEHOLDER]-overview.md`
- User Stories: `pmc/product/02-[PRODUCT_ABBR_PLACEHOLDER]-user-stories.md`
- Functional Requirements: `pmc/product/03-[PRODUCT_ABBR_PLACEHOLDER]-functional-requirements.md`
- Task-Specific FR Map: `pmc/product/_mapping/fr-maps/04-[PRODUCT_ABBR_PLACEHOLDER]-FR-wireframes-[SECTION_ID_PLACEHOLDER].md`
- User Journey: `pmc/product/02b-[PRODUCT_ABBR_PLACEHOLDER]-user-journey.md`
