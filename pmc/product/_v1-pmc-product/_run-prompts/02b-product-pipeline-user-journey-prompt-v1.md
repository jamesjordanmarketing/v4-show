...
1. **pmc/product/00-pipeline-seed-story.md** - Core vision and value proposition
2. **pmc/product/01-pipeline-overview.md** - Technical architecture and requirements
3. **pmc/product/02-pipeline-user-stories.md** - Detailed user stories and acceptance criteria
...
### Output Location
Save the completed **User Journey Document** in: `pmc/product/02b-pipeline-user-journey.md`
