...
/**
 * Meta-Prompt Generator for Integrated Spec Sections (v1)
 * 
 * Purpose: Generate customized meta-prompts for each section file that can be used
 *          to create progressive execution prompts.
 * 
 * Usage:
 *   node 04g-generate-section-meta-prompts_v1.js "Product Name" product-abbrev
 * 
 * Examples:
 *   node 04g-generate-section-meta-prompts_v1.js "LoRA Pipeline" pipeline
 *   node 04g-generate-section-meta-prompts_v1.js "BMO Extension" bmo
 * 
 * Input:
...
async function getValidDirectoryPath(description, defaultPath) {
  ...
  while (true) {
    ...
    console.log('❌ Directory not found. Please try again or type "q" to quit.');
  }
}
...
async function main() {
  try {
    ...
    if (args.length < 2) {
      console.error('❌ Usage: node 04g-generate-section-meta-prompts_v1.js "Product Name" product-abbrev');
      console.error('');
      console.error('Examples:');
      console.error('  node 04g-generate-section-meta-prompts_v1.js "LoRA Pipeline" pipeline');
      console.error('  node 04g-generate-section-meta-prompts_v1.js "BMO Extension" bmo');
      process.exit(1);
    }
    ...
    console.log('\n╔════════════════════════════════════════════════════════════╗');
    console.log('║     Meta-Prompt Generator for Integrated Specs (v1)        ║');
    console.log('╚════════════════════════════════════════════════════════════╝\n');
    ...
    console.log(`\n✓ Using directory: ${toDisplayPath(sectionsDir)}`);
    ...
    console.log(`\n✓ Loaded template: ${toDisplayPath(metaPromptPath)}`);
